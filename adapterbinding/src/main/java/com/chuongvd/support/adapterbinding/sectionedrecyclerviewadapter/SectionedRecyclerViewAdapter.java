...
import com.chuongvd.support.adapterbinding.sectionedrecyclerviewadapter.Section.State;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<ViewHolderBinding> {
    ...
    public ViewHolderBinding onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolderBinding viewHolder = null;
            ...
            if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
                ...
                switch (sectionViewType) {
                    case VIEW_TYPE_HEADER:
                        viewHolder =
                                section.getHeaderViewHolder(parent, getLayoutInflater(context()));
                        break;
                    case VIEW_TYPE_FOOTER:
                        viewHolder =
                                section.getFooterViewHolder(parent, getLayoutInflater(context()));
                        break;
                    case VIEW_TYPE_ITEM_LOADED:
                        viewHolder =
                                section.getItemViewHolder(parent, getLayoutInflater(context()));
                        break;
                    case VIEW_TYPE_LOADING:
                        viewHolder =
                                section.getLoadingViewHolder(parent, getLayoutInflater(context()));
                        break;
                    case VIEW_TYPE_FAILED:
                        viewHolder =
                                section.getFailedViewHolder(parent, getLayoutInflater(context()));
                        break;
                    case VIEW_TYPE_EMPTY:
                        viewHolder =
                                section.getEmptyViewHolder(parent, getLayoutInflater(context()));
                        break;
                    default:
    ...
    //    }
    //
    //    private ViewHolderBinding getHeaderViewHolder(ViewGroup parent, Section section) {
    //        View view;
     ...
     * @param itemCount number of items inserted in the section
     */
    public void notifyItemRangeInsertedInSection(Section section, int positionStart,
            int itemCount) {
     ...
     * @param itemCount number of items removed from the section
     */
    public void notifyItemRangeRemovedFromSection(Section section, int positionStart,
            int itemCount) {
